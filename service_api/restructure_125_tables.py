...
# f = open('response_1711519197812.json')
# data = json.load(f)
# f.close()
# for page_name, page_data in data.items():
#     if 'Page_' in page_name:
#         output=restructure.identify_table_structure(page_data['table_data'])

#         output_filename = f'restructure_output{page_name}.json'
