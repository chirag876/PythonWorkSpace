...
class TEXTRACT:
    ...
    def get_mapped_json(self,file_name,page_list):
        ...
        for page_number in page_list:
            ...
            gray_img_bytes_io = io.BytesIO(img_bytes)
            ...
            main_dict[f"Page_number_{page_number}"] = {"all_kvs": filtered_kvs, "table_data": tables}
        
        return main_dict,page_count
