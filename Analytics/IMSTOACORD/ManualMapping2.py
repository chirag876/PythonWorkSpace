...
class ManualMapping:
    ...
    def mapandcreatecsvs(self):
        ...
        for config_label in config_labels:   
            ...
            blob = CsvToBlob()
            blob.upload_file_chunks(f'./Blob_CSV/{config_label}.csv',f'datapulse/{config_label}.csv')
    ...
    def BlobCSV(self,df):
        ...
        for config_label in config_labels:   
            ...
            csv_file_path=f'./Blob_CSV/{config_label}.csv'
            updated_columns.to_csv(csv_file_path, index=False)
